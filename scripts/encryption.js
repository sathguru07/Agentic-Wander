...
1. Generate Key (Run in terminal):
...
3. Use in code:
   ...
   const secret = encrypt("My Super Secret Password");
   console.log(secret); // outputs: iv:tag:content
   
   const plain = decrypt(secret);
   console.log(plain); // outputs: My Super Secret Password
*/
